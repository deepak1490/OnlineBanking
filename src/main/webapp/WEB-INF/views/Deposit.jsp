				...
				<table width="70%" border="0" align="center" cellpadding="2"
					...
					<tr>
						...
						<td><input name="userName" type="text" id="uname"
							readonly="readonly" value="${userProfile.firstName}" required /></td>
					</tr>
					<tr>
						<td width="39%">&nbsp;</td>
						<td width="3%">&nbsp;</td>
					...
					<tr>
						...
						<td><input name="accountNumber" type="text" id="uname"
							readonly="readonly" value="${account.accountNumber}" required /></td>
					</tr>
					<tr>
						<td width="39%">&nbsp;</td>
						<td width="3%">&nbsp;</td>
					...
					<tr>
						...
						<td></td>
						<td><form:input type="file" path="check" name="file" required = "required" ></form:input></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
