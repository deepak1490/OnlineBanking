...
<script type="text/javascript">
	function select() {
		...
		var textbox = document.getElementById('payeeacc');
		if (a != 'select') {
...
<body>
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<form method="post" action="doTransfer" id="transferForm">
				<table width="70%" border="0" align="center" cellpadding="2"
					...
					<tr>
						...
						<td><input name="userName" type="text" id="uname"
							readonly="readonly" value="${userProfile.firstName}" /></td>
					</tr>
					<tr>
						<td width="39%">&nbsp;</td>
						<td width="3%">&nbsp;</td>
					...
					<tr>
						...
						<td>:</td>
						<td><select required id="dd1" onchange="select()">
								<option value="">select</option>
								<c:forEach items="${payee}" var="option">
									<option value="${option.payeeUserName}"
										${param.dd1 == option.payeeUserName ? 'selected' : ''}>${option.payeeUserName}</option>
								</c:forEach>
						</select></td>
					</tr>
					<tr>
