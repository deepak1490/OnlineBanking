...
<body>
	...
	<div class="header">
		<div>
			Manaran<span>Bank</span>
		</div>
	</div>
	<br>
	<div class="login">
		<form:form method="POST" commandName="user">
			<form:input type="text" placeholder="username" name="user"
				path="userName" />
			<br>
			...
			<input type="checkbox" name="Remember" value="Remember" checked> Remember me for 1 week<br>
