...
<body>
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<form method="post" action="doEmailTransfer">
				<table width="70%" border="0" align="center" cellpadding="2"
					...
					<tr>
						<td><div align="right">Payee EmailID</div></td>
						<td>:</td><td><input name="email" type="email" required="required"/></td>
					</tr>
					<tr>
						<td width="39%">&nbsp;</td>
						<td width="3%">&nbsp;</td>
